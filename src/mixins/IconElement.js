 ...
 * @param {Object|string} [config.icon=''] The symbolic name of the icon (e.g., ‘remove’ or ‘menu’), or a map of
 ...
 * @param {string|Function} [config.iconTitle] A text string used as the icon title, or a function that returns title
